# Google Reader compatible API implementation · FreshRSS

---

- Google Reader compatible API implementation · FreshRSS
- [https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html)
- Documentation center
- 2026-07-29 19:43

---

## **Google Reader compatible API implementation** ​[#](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html#google-reader-compatible-api-implementation)

See [Mobile access](https://freshrss.github.io/FreshRSS/en/users/06_Mobile_access.html) for general aspects of API access.

See also the [page about our Fever compatible API](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html) for another possibility (less powerful).

## **RSS clients** ​[#](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html#rss-clients)
...
## **Usage & Authentication** ​[#](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html#usage-amp-authentication)

Before you can start using this API, you have to enable and setup API access, which is [documented here](https://freshrss.github.io/FreshRSS/en/users/06_Mobile_access.html), and then reset the user’s API password.

Then point your mobile application to the `greader.php`​ address (e.g. `https://freshrss.example.net/api/greader.php`).

## **Compatible clients** ​[#](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html#compatible-clients)
...
## **Google Reader compatible API** ​[#](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html#google-reader-compatible-api)
...
### **API documentation from the original Google Reader** ​[#](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html#api-documentation-from-the-original-google-reader)
...
### **API documentation from other compatible servers** ​[#](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html#api-documentation-from-other-compatible-servers)
...
### **Synchronisation strategy** ​[#](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html#synchronisation-strategy)
...
- *[Synchronisation recommendation](https://github.com/FreshRSS/FreshRSS/issues/2566#issuecomment-541317776)*​[ by Alkarex](https://github.com/FreshRSS/FreshRSS/issues/2566#issuecomment-541317776)
- *[Additional synchronisation tips](https://github.com/jocmp/capyreader/discussions/533#discussioncomment-11341808)*​[ by Alkarex](https://github.com/jocmp/capyreader/discussions/533#discussioncomment-11341808)
- *[The Right Way to Sync](https://github.com/bazqux/bazqux-api#user-content-the-right-way-to-sync)*​[ by BazQux](https://github.com/bazqux/bazqux-api#user-content-the-right-way-to-sync)
